...
***rdenhotspots*** is package development by department of prevention and control of vector-borne diseases of the [Secretary of Health of Veracruz](https://www.ssaver.gob.mx/) with colaboration of the national dengue prevention and control program of the [CENAPRECE](https://www.gob.mx/salud/cenaprece) and entomology laboratory of [INDRE](https://www.gob.mx/salud/acciones-y-programas/instituto-de-diagnostico-y-referencia-epidemiologicos-indre).

The goal of ***rdenhotspots*** is to carry out a spatial analysis of dengue:
...
See also the list of [contributors](https://github.com/fdzul/rdenhotspots/contributors) who participated in this project.
